...
// NOTE: MAC 84:e3:42:b2:61:bf
				correct_rf_config[39] = getRandomInt(0,255);// replace 0xb2
				correct_rf_config[40] = getRandomInt(0,255);// replace 0x61
				correct_rf_config[41] = getRandomInt(0,255);// replace 0xbf
			}
...
// NOTE: MAC 38:1f:8d:38:57:0e
				correct_rf_config[39] = getRandomInt(0,255);// replace 0x38
				correct_rf_config[40] = getRandomInt(0,255);// replace 0x57
				correct_rf_config[41] = getRandomInt(0,255);// replace 0x0e
			} else {
				correct_rf_config = [];
			}
